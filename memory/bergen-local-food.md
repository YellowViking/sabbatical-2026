...
|---|---|
| Bryggen walk | **YES** |
| **One** of Fløyen **or** Ulriken ridge (not both cable-car tourist days) | YES |
| Stoltzekleiven → Ulriken ridge | YES if clear + legs |
| KODE | Rain day |
| **Flåmsbana** | **YES** — book early |
| Nærøyfjord cruise | YES on clear/afternoon burn-off |
| **Stegastein** | YES if time/weather |
| **Undredal** / Aurland base vs Flåm hub | Prefer quieter nights |
| Rimstigen (Gudvangen/Bakka) | YES if dry rock |
| Ægir | Rain / dinner |
| Torget tourist fish tents | **Skip** sit-down |
| Trolltunga | **No** |

### Late Aug / early Sep
Rain is normal — shell + pack cover mandatory. Book **Flåmsbana + connecting cruise** that match; keep fjord beds free-cancel if you can.
...
|---|---|
| Bergen city | **Skyss** |
| Norway planner | **Entur** |
| Trains | **Vy** (Bergen S ↔ Myrdal / Oslo) |
| Flåm railway + many combos | **flamsbana.no** / Norway’s Best |
| Stegastein | Operator **shuttle** (book) |
| Fjord buses | Entur night-before check |
...
| **Bryggen** | Walk ~10–15m |
| **Fløibanen** | Walk ~10–15m · hike-up free / funicular down optional ~$18 rt |
| **KODE** | Walk ~10m (lake) |
| **Stoltzekleiven / Sandviken** | Bus toward Sandviken **or** walk 25–40m |
| **Ulriken cable** | Skyss bus toward Ulriken |
| **Pingvinen / Trekroneren / Godt Brød** | Walk sentrum 5–15m |
| **HI Montana** | Bus uphill — **bad** base for early Myrdal trains |

### Fjord pocket — bed → places
| Go to | How |
|---|---|
| **Flåm Camping** | Walk ~5m from station |
| **Svingen Guesthouse** | Short walk in Flåm |
| **Undredal** overnight | Bus/taxi from Flåm ~20–30m |
| **Aurland** (Marianne Bakeri) | Bus ~10m from Flåm |
| **Ægir** | Walk Flåm centre |
| **Rimstigen / Gudvangen / Bakka** | Bus/boat — **Entur** night before · no wet rock |
| **Nærøyfjord cruise** | Pier on ticket (Flåm **or** Gudvangen) |
| **Stegastein** | Booked shuttle from Flåm area ~$35 |
| **Coop picnic** | Walk from Flåm station |
| **Myrdal → east** | Flåmsbana ↑ then Vy |

**Fog rule:** no blind cruise — valley bus + Ægir + stave/cheese. Sail when layers lift.  
**Luggage:** overhead on Flåmsbana OK; daypack only on Rimstigen.

---

## Sample plan — **6n default** *(3n Bergen + 3n fjord)*

| Day | Base | Nature / sights | Food |
|---|---|---|---|
| **D0** | Bergen | Arrive SVG · **Bryggen** alleys · harbour edge | **Trekroneren** pølse · **Godt Brød** skillingsbolle |
| **D1** | Bergen | Clear: **Stoltzekleiven → ridge → Ulriken** (down cable optional) · *or* Fløyen hike-up | Pack lunch · dinner **Pingvinen** fiskesuppe / plukkfisk |
| **D2** | Bergen | Rain: **KODE** · easy Fløyen if breaks · Sandviken stroll | Picnic / kitchen · second Pingvinen or inland café |
| **D3** | → fjord | **Bergensbanen Bergen→Myrdal → Flåmsbana → Flåm** · bus/taxi **Undredal or Aurland** | Train picnic · simple dinner at base |
| **D4** | fjord | **Rimstigen** if dry · *else* valley / stave church / cheese · evening **Ægir** Flåm | Picnic + Ægir pork/venison |
| **D5** | fjord | **Nærøyfjord** cruise (push if morning fog) · **Stegastein** shuttle | **Marianne Bakeri** (Aurland) · Flåm Bakeri backup |
| **D6 / exit** | transit | Flåmsbana↑ Myrdal → east toward OSL/STO *or* back BGO flight | Bakery + long-leg snacks |

**4n compress:** drop KODE day + Stegastein; 2+2.  
...
## Nature & fjords 🌿 *(priority)*

### Bergen city mountains

| Place | ★ | Time | ~USD | Notes | Maps |
|---|---|---|---|---|---|
| **Bryggen** | 4.7 | 1–2h | **free** | UNESCO wharf · alleys | [Maps](https://www.google.com/maps/search/?api=1&query=Bryggen+Bergen) |
| **Fløyen** | 4.8 | 1–2h+ | funicular rt ~$18 · **hike free** | Prefer hike-up / funicular down if tired | [Maps](https://www.google.com/maps/search/?api=1&query=Fl%C3%B8yen+Bergen) |
| **Ulriken** | 4.8 | 2–4h | cable rt ~$36 · ridge free | Pair with Stoltzekleiven on clear day | [Maps](https://www.google.com/maps/search/?api=1&query=Mount+Ulriken+Bergen) |
| **Stoltzekleiven** | 4.7 | 1.5–2h up | **free** | 908 stone stairs · Sandviken start | [Maps](https://www.google.com/maps/search/?api=1&query=Stoltzekleiven+Bergen) |
| **Sandviken** streets | — | 1h | **free** | Wooden quarter · less cruise crush | [Maps](https://www.google.com/maps/search/?api=1&query=Sandviken+Bergen) |
| **KODE** | 4.5 | 2–3h | ~$16 | **Rain** · Munch etc. | [Maps](https://www.google.com/maps/search/?api=1&query=KODE+Bergen) |

### Fjord block *(book early)*

| Place | ★ | Time | ~USD | Book? | Maps |
|---|---|---|---|---|---|
| **Flåmsbana** | 4.9 | 1h one-way | ~$52 one-way | **Yes — weeks ahead** | [Maps](https://www.google.com/maps/search/?api=1&query=Fl%C3%A5m+Railway) |
| **Nærøyfjord cruise** | 4.9 | ~2h | ~$50–64 | **Yes** · skip in fog | [Maps](https://www.google.com/maps/search/?api=1&query=N%C3%A6r%C3%B8yfjord+cruise) |
| **Stegastein** | 4.8 | ~1.5h w/ shuttle | shuttle ~$35 | Recommended | [Maps](https://www.google.com/maps/search/?api=1&query=Stegastein+viewpoint) |
| **Undredal** village | 4.7 | base | free wander | Stay here for quiet | [Maps](https://www.google.com/maps/search/?api=1&query=Undredal+Norway) |
| **Rimstigen** | 4.6 | 4–6h | free · park ~$7 | Steep · **no wet rock** | [Maps](https://www.google.com/maps/search/?api=1&query=Rimstigen+Gudvangen) |
| **Ægir** | 4.6 | 1–2h | dinner ~$30–40 | Walk-in / eve | [Maps](https://www.google.com/maps/search/?api=1&query=%C3%86gir+BrewPub+Fl%C3%A5m) |

**Logistics spine:** Bergen → **Myrdal** (Bergensbanen) → **Flåm** (Flåmsbana) → local bus/boat to **Undredal/Aurland**. Match tickets on [flamsbana.no](https://www.flamsbana.no) / Norway’s Best style connectors.

---

## Food

*Norway-expensive. Win = husmannskost inland, pølse, skillingsbolle, guest kitchens + Coop picnic — not Torget tourist tents or Bryggen view tax.*

### City (Bergen) — order this

| Place | ★ | Order | ~USD | Maps |
|---|---|---|---|---|
| **Pingvinen** | ~4.2–4.5 ⚠️ value | **Fiskesuppe** or **plukkfisk** | $20–24 | [Maps](https://www.google.com/maps/search/?api=1&query=Pingvinen+Bergen) |
| **Trekroneren** | 4.6–4.7 | **Reinsdyrpølse** + lingon | $7–9 | [Maps](https://www.google.com/maps/search/?api=1&query=Trekroneren+Bergen) |
| **Godt Brød** | 4.5 | **Skillingsbolle** + filter | $5–6 bun | [Maps](https://www.google.com/maps/search/?api=1&query=Godt+Br%C3%B8d+Bergen) |

**Skip:** Torget “fish market” sit-down tents (cruise pricing) · Bryggen waterfront cafés for full meals.

### Fjord nights — order this

| Place | ★ | Order | ~USD | Maps |
|---|---|---|---|---|
| **Marianne Bakeri & Kafe** (Aurland) | 4.7–4.8 | Soup / focaccia / cream buns | $6–13 | [Maps](https://www.google.com/maps/search/?api=1&query=Marianne+Bakeri+Aurland) |
| **Ægir BrewPub** (Flåm) | 4.4–4.6 ⚠️ vibe | Pork belly or venison + beer | $29–38 | [Maps](https://www.google.com/maps/search/?api=1&query=%C3%86gir+BrewPub+Fl%C3%A5m) |
| **Flåm Bakeri** | ~4.3–4.4 | Kardemommebolle / quick bite | $5–12 | [Maps](https://www.google.com/maps/search/?api=1&query=Fl%C3%A5m+Bakeri) |
| **Undredal** | — | **Geitost** / village café | var. | [Maps](https://www.google.com/maps/search/?api=1&query=Undredal+goat+cheese) |

### Picnic strategy *(fjord days)*
Coop Extra / Rema (Bergen) · Coop Marked (Flåm): reker + lemon · røkt laks + knekkebrød · brunost + lefse · optional engangsgrill + pølse. Guest kitchen lodging multiplies this.

### 6n eat sketch
| Nights | Pattern |
|---|---|
| Bergen | 1× Pingvinen · 1× Trekroneren · skillingsbolle daily · kitchen 1 night |
| Fjord | picnic hike day · 1× Ægir · 1× Marianne · Undredal cheese |

---

## Lodging *(split: city + fjord)*

*Criteria §7 · free cancel while flex · late-Aug ballpark · AI Mode Pro Aug 2026. **Privacy curtains rare** in legacy NO hostels — bring eye mask. YMCA + Budgetel **closed**.*
...
| Escape cruise throngs at night | **Undredal** or **Aurland** (day-trip Flåm) |

**Budget vs §6:** block still ~$210 all-in/day blended (fjord tickets heavy). Dorm/cabin + picnic pulls food down; Flåmsbana+cruise are the spike (book, don’t “day-rate” them away).

---

## Book-before list
1. **Flåmsbana** + matching **Nærøyfjord** departure  
2. Fjord beds (sell out late Aug) — free cancel if possible  
3. Optional Stegastein shuttle  
4. Exit: Myrdal→east rail **or** BGO→STO flight  
